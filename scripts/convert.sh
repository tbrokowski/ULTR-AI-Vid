...
# =========================
main() {
  hdr "Convert Models to TF.js Format"
  ...
  for exp_name in "${!EXPERIMENTS[@]}"; do
    ...
    for fold in "${FOLDS[@]}"; do
      ...
      OUTPUT_DIR="./${exp_dir}/fold${fold}/tfjs_model"
      ...
      if python ultr_ai/network_architecture/converter.py \
    ...
    log_ok "Converted $exp_name completed"
    echo ""
  done
  
  hdr "Conversion to TF.js complete!"
}
