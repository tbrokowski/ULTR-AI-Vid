...
class MultiTaskConfig:
    ...
    vision_pretrained_weights: Optional[str] = None
    clip_unfreeze_last_n_layers: int = 1
    ...
    def __post_init__(self):
        ...
        bool_fields = [
            ...
            'use_amp', 'reset_optimizers', 'train_visual_projection'
        ]
...
def create_argument_parser():
    ...
    parser.add_argument('--vision-pretrained-weights', type=str, help='Path to a CLIP vision warm-start checkpoint')
    parser.add_argument('--clip-unfreeze-last-n-layers', type=int, help='How many CLIP encoder blocks to fine-tune')
    parser.add_argument('--freeze-backbone', action='store_true', help='Keep the CLIP encoder frozen')
    parser.add_argument('--no-freeze-backbone', dest='freeze_backbone', action='store_false', help='Allow CLIP encoder fine-tuning')
    parser.add_argument('--clip-model-name', type=str, help='Hugging Face CLIP vision model id')
    ...
    parser.set_defaults(
        use_pathology_loss=None,
        use_amp=None,
        use_cross_site_attention=None,
        use_site_positional_encoding=None,
