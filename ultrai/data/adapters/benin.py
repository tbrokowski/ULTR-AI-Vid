"""
Benin dataset adapter used by the public `train` and `finetune` entrypoints.

This adapter owns the Benin-specific metadata conventions:
- patient id matching
- Benin site naming
- Benin pathology label extraction
- Benin split CSV interpretation
