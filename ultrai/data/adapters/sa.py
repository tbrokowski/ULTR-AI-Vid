"""
South Africa dataset adapter used by the public `train` and `finetune` entrypoints.

This adapter owns the SA-specific metadata conventions:
- SA/TrUST patient id reconciliation
- SA site-code normalization
- SA pathology label extraction
- SA split CSV interpretation

Shared video/image transform primitives live in `ultrai.data.adapters.common`.
"""
...
from ultrai.data.adapters.common import (
    NUM_PATH_CLASSES,
    SimpleVideoTransforms,
    TemporallyConsistentTransforms,
)
